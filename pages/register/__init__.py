...
class RegisterPage(BasePage):
    ...
    def fill_personal_info(
        self, first_name: str, last_name: str, address: str, email: str, phone: str
    ):
    ...
    def select_hobbies(
        self, hobbies: List[str] = random.choice(["Cricket", "Movies", "Hockey"])
    ):
    ...
    def select_language(self, language: str = "English"):
        ...
        if self.page.is_visible(
            self.__locators.GENERIC_LANGUAGE_ENTITY.format(language)
        ):
    ...
    def select_birth_date(
        self, year: str = "1990", month: str = "January", day: str = "1"
    ):
